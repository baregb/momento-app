    ...
    <main style={{ minHeight: '100vh', backgroundColor: 'var(--bg-base)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
        <div style={{ width: '100%', maxWidth: '24rem', backgroundColor: 'var(--bg-surface)', borderRadius: '1.25rem', padding: '2rem 1.5rem', border: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div>
            <h1 style={{ color: 'var(--text-primary)', marginBottom: '0.25rem' }}>Welcome back</h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>Sign in to your host account</p>
          </div>
          ...
          <div style={{ textAlign: 'right' }}>
            <Link
              ...
              style={{ color: 'var(--text-muted)', fontSize: '0.825rem' }}
            >
              Forgot password?
            </Link>
          </div>
          ...
          <p style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
            No account?{' '}
            <Link href="/auth/register" style={{ color: 'var(--text-silver)', fontWeight: 600 }}>
              Create one
            </Link>
          </p>
        </div>
